                ...
                <div class="page-header-content">
                    <div class="row align-items-center justify-content-between pt-3">
                        ...
                        <div class="col-12 col-xl-auto mb-3">
                            <a class="btn btn-sm btn-light text-primary" href="{{ route('arsip') }}">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control @error('bets_no') is-invalid @enderror"
                                            value="{{ old('bets_no') }}" name="bets_no" placeholder="Nomor Bets.."
                                            required>
                                    </div>
                                    @error('bets_no')
                                        <div class="invalid-feedback">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="date"
                                            ...
                                            value="{{ old('bets_received') }}" name="bets_received" required>
                                    </div>
                                    @error('bets_received')
                                        <div class="invalid-feedback">
                                            {{ $message }}
